    ...
    def write_arithmetic(self, command: str) -> None:
        ...
        if command in SHIFT:
            ...
            self.__output_stream.write('\n// ' + command + '\n' +
                                       C_TEMPLATE + C_COMMANDS[command])
        elif command in J_COMMANDS:
            self.__output_stream.write(
                '\n// ' + command + '\n' +
                J_TEMPLATE[0] + self.__file_name + str(self.__j_counter) +
                J_TEMPLATE[1] + J_COMMANDS[command] +
                J_TEMPLATE[2] + self.__file_name + str(self.__j_counter) +
                J_TEMPLATE[3] + self.__file_name + str(self.__j_counter) +
                J_TEMPLATE[4] + self.__file_name + str(self.__j_counter) +
                J_TEMPLATE[5])
            self.__j_counter += 1
        elif command in NOT_NEG_COMMANDS:
            self.__output_stream.write('\n// ' + command + '\n' +
                                       NOT_NEG_COMMANDS[command])
